    ...
    def from_urdf(cls, file_path: str) -> Self:
        ...
        for joint in root.findall("joint"):
            ...
            if j_type not in [
                ...
                "continuous",
                "fixed",
            ]:  # We only use these types of joints
                continue
            ...
            if axis_tag is not None:
                axis = Robot._parse_string_to_floats(
                    axis_tag.get("xyz", "1 0 0")
                )  # Standard default: X axis

            else:
                axis = [1.0, 0.0, 0.0]

            joint_data = {"type": j_type, "xyz": xyz, "rpy": rpy, "axis": axis}
